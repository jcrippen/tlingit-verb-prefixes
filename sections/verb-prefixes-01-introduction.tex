...
\FIXME{Sources of information.
Primary sources:
\cite{leer:1991}, \cite{eggleston:2013a}.
Secondary sources:
\cite{story:1966}, \cite{story-naish:1973}
Data sources:
\cite{eggleston:2017}, \cite{edwards:2009}, \cite{story-naish:1973}, \cite{boas:1917}, \cite{shotridge:1915}, \cite{shotridge:1914}, \cite{shotridge:1912}
}
\end{multicols}
