...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes		&\Df{d}-\Ff{s}-\If{i}\rlap{-}		&\Df{d}-\If{i}\rlap{-}		&\Ff{s}-\If{i}\rlap{-}		&\Df{d}-			&\Df{d}-\Ff{s}\rlap{-}		&\Ff{s}-			&\If{i}-			&—\\
\midrule
% yishikʼáan and tl. yishakʼaan Eggleston 2017: 50249 & 50279
—			&—		&\Sf{yi}-	&\Sf{yi}-		&\Sf{yi}\Df{d}\Ff{z}\If{i}		&\Sf{yi}\Df{d}\If{i}		&\Sf{yi}\Ff{s}\If{i}		&\Sf{yi}\Df{d}\Ef{a}		&\Sf{yi}\df{\Ff{s}}		&\Sf{yi}\Ff{s}\Ef{a}		&\Sf{yee}\If{y}			&\Sf{yi}\\
...
% yoo x̱ʼayeeli.átk Eggleston 2017: 8782
			&—		&		&			&					&				&\Qf{x̱ʼa}\Sf{yi}\Ff{s}\If{i}	&				&				&				&				&\\
...
% yéi sh tuydinook Eggleston 2017: 77432
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes		&\Df{t}-\Ff{s}-\If{i}\rlap{-}		&\Df{t}-\If{i}\rlap{-}		&\Ff{s}-\If{i}\rlap{-}		&\Df{t}-			&\Df{t}-\Ff{s}\rlap{-}		&\Ff{s}-			&\If{i}-			&—\\
\midrule
—			&—		&\Sf{ji}-	&\Sf{ji}-		&\Sf{ji}.\Df{t}\Ff{s}\If{i}		&\Sf{ji}.\Df{t}\If{i}		&\Sf{ji}.\Ff{s}\If{i}		&\Sf{ji}.\Df{t}\Ef{a}		&\Sf{ji}\df{\Ff{s}}		&\Sf{ji}.\Ff{s}\Ef{a}		&\Sf{jiː}\If{j}			&\Sf{ji}\\
