...
\begin{multicols}{2}
\noindent
\FIXME{The only unmarked aspect forms with irrealis and modal are prospective and potential.
The prospective also has g-, so it’s out.
The potential always has i- if I recall correctly.
So this is the opposite of the preceding subsection, only forms with i- are possible!}
\end{multicols}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{d}-\Ff{s}-\If{i}\rlap{-}		&\Df{d}-\If{i}\rlap{-}			&\Ff{s}-\If{i}\rlap{-}			&\Df{d}-	&\Df{d}-\Ff{s}\rlap{-}	&\Ff{s}-	&\If{i}-				&—\\
\midrule
—			&\Rf{u}-\Mf{g̱}-	&—		&\Rf{u}-\Mf{g̱}-			&\Mf{g̱}\Rf{w}\Ef{a}\Df{d}\Ff{z}\If{i}	&\Mf{g̱}\Rf{w}\Ef{a}\Df{d}\If{i}		&\Mf{g̱}\Rf{w}\Ef{a}\Ff{s}\If{i}		&⁎		&⁎			&⁎		&\Mf{g̱}\Rf{w}\Ef{a}\If{a}		&⁎\\
\Qf{a}- arg./expl.	&\Rf{u}-\Mf{g̱}-	&—		&\Qf{a}-\Rf{u}-\Mf{g̱}-		&\Qf{o}\Rf{o}\Mf{x̱}\Df{d}\Ff{z}\If{i}	&\Qf{o}\Rf{o}\Mf{x̱}\Df{d}\If{i}		&\Qf{o}\Rf{o}\Mf{x̱}\Ff{s}\If{i}		&⁎		&⁎			&⁎		&\Qf{o}\Rf{o}\Mf{g̱}\Ef{a}\If{a}		&⁎\\
\Qf{ka}- qualifier	&\Rf{u}-\Mf{g̱}-	&—		&\Qf{ka}-\Rf{u}-\Mf{g̱}-		&\Qf{ko}\Rf{o}\Mf{x̱}\Df{d}\Ff{z}\If{i}	&\Qf{ko}\Rf{o}\Mf{x̱}\Df{d}\If{i}	&\Qf{ko}\Rf{o}\Mf{x̱}\Ff{s}\If{i}	&⁎		&⁎			&⁎		&\Qf{ko}\Rf{o}\Mf{g̱}\Ef{a}\If{a}	&⁎\\
\Qf{x̱ʼe}- ‘mouth’	&\Rf{u}-\Mf{g̱}-	&—		&\Qf{x̱ʼe}-\Rf{u}-\Mf{g̱}-	&\Qf{x̱ʼe}\Rf{i}\Mf{x̱}\Df{d}\Ff{z}\If{i}	&\Qf{x̱ʼe}\Rf{i}\Mf{x̱}\Df{d}\If{i}	&\Qf{x̱ʼe}\Rf{i}\Mf{x̱}\Ff{s}\If{i}	&⁎		&⁎			&⁎		&\Qf{x̱ʼe}\Rf{i}\Mf{g̱}\Ef{a}\If{a}	&⁎\\
\Qf{ji}- ‘hand’		&\Rf{u}-\Mf{g̱}-	&—		&\Qf{ji}-\Rf{u}-\Mf{g̱}-		&\Qf{je}\Rf{e}\Mf{x̱}\Df{d}\Ff{z}\If{i}	&\Qf{je}\Rf{e}\Mf{x̱}\Df{d}\If{i}	&\Qf{je}\Rf{e}\Mf{x̱}\Ff{s}\If{i}	&⁎		&⁎			&⁎		&\Qf{je}\Rf{e}\Mf{g̱}\Ef{a}\If{a}	&⁎\\
\Qf{tu}- ‘inside’	&\Rf{u}-\Mf{g̱}-	&—		&\Qf{tu}-\Rf{u}-\Mf{g̱}-		&\Qf{to}\Rf{o}\Mf{x̱}\Df{d}\Ff{z}\If{i}	&\Qf{to}\Rf{o}\Mf{x̱}\Df{d}\If{i}	&\Qf{to}\Rf{o}\Mf{x̱}\Ff{s}\If{i}	&⁎		&⁎			&⁎		&\Qf{to}\Rf{o}\Mf{g̱}\Ef{a}\If{a}	&⁎\\
\bottomrule
\end{tabular}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{t}-\Ff{s}-\If{i}\rlap{-}					&\Df{t}-\If{i}\rlap{-}					&\Ff{s}-\If{i}\rlap{-}					&\Df{t}-	&\Df{t}-\Ff{s}\rlap{-}	&\Ff{s}-	&\If{i}-					&—\\
\midrule
—			&\Rf{u}-\Mf{q}-	&—		&\Rf{u}-\Mf{q}-			&\Mf{q}\Rf{ʷ}\Ef{a}.\Df{t}\Ff{s}\If{i}				&\Mf{q}\Rf{ʷ}\Ef{a}.\Df{t}\If{i}			&\Mf{q}\Rf{ʷ}\Ef{a}.\Ff{s}\If{i}			&⁎		&⁎			&⁎		&\Mf{q}\Rf{ʷ}\Ef{a}\If{a}			&⁎\\
\Qf{ʔa}- arg./expl.	&\Rf{u}-\Mf{q}-	&—		&\Qf{ʔa}-\Rf{u}-\Mf{q}-		&\Qf{ʔu}\Rf{ː}\Mf{χ}\Rf{ʷ}.\Df{t}\Ff{s}\If{i}			&\Qf{ʔu}\Rf{ː}\Mf{χ}\Rf{ʷ}.\Df{t}\If{i}			&\Qf{ʔu}\Rf{ː}\Mf{χ}\Rf{ʷ}.\Ff{s}\If{i}			&⁎		&⁎			&⁎		&\Qf{ʔu}\Rf{ː}.\Mf{q}\Ef{a}\If{a}		&⁎\\
\Qf{kʰa}- qualifier	&\Rf{u}-\Mf{q}-	&—		&\Qf{kʰa}-\Rf{u}-\Mf{q}-	&\Qf{kʰ}\Rf{ʷ}\Qf{u}\Rf{ː}\Mf{χ}\Rf{ʷ}.\Df{t}\Ff{s}\If{i}	&\Qf{kʰ}\Rf{ʷ}\Qf{u}\Rf{ː}\Mf{χ}\Rf{ʷ}.\Df{t}\If{i}	&\Qf{kʰ}\Rf{ʷ}\Qf{u}\Rf{ː}\Mf{χ}\Rf{ʷ}.\Ff{s}\If{i}	&⁎		&⁎			&⁎		&\Qf{kʰ}\Rf{ʷ}\Qf{u}\Rf{ː}.\Mf{q}\Ef{a}\If{a}	&⁎\\
\Qf{χʼe}- ‘mouth’	&\Rf{u}-\Mf{q}-	&—		&\Qf{χʼe}-\Rf{u}-\Mf{q}-	&\Qf{χʼe}\Rf{ː}\Mf{χ}.\Df{t}\Ff{s}\If{i}			&\Qf{χʼe}\Rf{ː}\Mf{χ}.\Df{t}\If{i}			&\Qf{χʼe}\Rf{ː}\Mf{χ}.\Ff{s}\If{i}			&⁎		&⁎			&⁎		&\Qf{χʼe}\Rf{ː}.\Mf{q}\Ef{a}\If{a}		&⁎\\
\Qf{tʃi}- ‘hand’	&\Rf{u}-\Mf{q}-	&—		&\Qf{tʃi}-\Rf{u}-\Mf{q}-	&\Qf{tʃi}\Rf{ː}\Mf{χ}.\Df{t}\Ff{s}\If{i}			&\Qf{tʃi}\Rf{ː}\Mf{χ}.\Df{t}Ff{s}\If{i}			&\Qf{tʃi}\Rf{ː}\Mf{χ}.\Ff{s}\If{i}			&⁎		&⁎			&⁎		&\Qf{tʃi}\Rf{ː}.\Mf{q}\Ef{a}\If{a}		&⁎\\
\Qf{tʰu}- ‘inside’	&\Rf{u}-\Mf{q}-	&—		&\Qf{tʰu}-\Rf{u}-\Mf{q}-	&\Qf{tʰu}\Rf{ː}\Mf{χ}\rf{\Qf{ʷ}}.\Df{t}\Ff{s}\If{i}		&\Qf{tʰu}\Rf{ː}\Mf{χ}\rf{\Qf{ʷ}}.\Df{t}\If{i}		&\Qf{tʰu}\Rf{ː}\Mf{χ}\rf{\Qf{ʷ}}.\Ff{s}\If{i}		&⁎		&⁎			&⁎		&\Qf{tʰu}\Rf{ː}.\Mf{q}\Ef{a}\If{a}		&⁎\\
\bottomrule
\end{tabular}
