...
Each section is further divided up into subsections reflecting the prefixes that accompany the aspectual prefixes, namely the irrealis prefix (\fm{u-}) and the modality prefix (\fm{g̱-}).
...
Finally, the last pair of table gives the fourth person (indefinite, nonspecific) human subject \fm{du-} ‘someone, people, they’.
...
\section{Unmarked aspect (imperfective or \textit{∅}-conjugation)}
...
%%%
\clearpage
\subsection{\textit{N}-conjugation with irrealis \textit{u-}}

%%%
%%% N-conjugation with modal
%%%
\subsection{\textit{N}-conjugation with modal \textit{g̱-}}

%%%
%%% N-conjugation with irrealis and modal
%%%
\subsection{\textit{N}-conjugation with irrealis and modal}

\clearpage
%%%
%%% G̱-conjugation
%%%
\section{\textit{G̱}-conjugation}

%%%
%%% G̱-conjugation with irrealis 
%%%
\subsection{\textit{G̱}-conjugation with irrealis \textit{u-}}

%%%
%%% G̱-conjugation with modal
%%%
\subsection{\textit{G̱}-conjugation with modal \textit{g̱-}}

%%%
%%% G̱-conjugation with irrealis and modal
%%%
\subsection{\textit{G̱}-conjugation with irrealis and modal}
...
%%%
\subsection{\textit{G}-conjugation with irrealis \textit{u-}}

%%%
%%% G-conjugation with modal
%%%
\subsection{\textit{G}-conjugation with modal \textit{g̱-}}

%%%
%%% G-conjugation with irrealis and modal
%%%
\subsection{\textit{G}-conjugation with irrealis and modal}
