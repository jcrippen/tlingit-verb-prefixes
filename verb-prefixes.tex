...
Since the imperfective aspect does not occur with modal \fm{\Mf{g̱}-}, this rules out the combination of \fm{\Rf{u}-} and \fm{\Mf{g̱}-}.
...
The only context for all three of irrealis \fm{\Rf{u}-}, the \fm{∅} conjugation prefix, and modal \fm{\Mf{g̱}-} is the potential modality.
All prefix combinations in this section therefore represent a subset of potential modality forms.

Potential modality forms normally include the stative \fm{\If{i}-} classifier prefix.
