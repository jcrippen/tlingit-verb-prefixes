...
\Qf{x̱ʼe}- ‘mouth’	&\Rf{u}-	&—		&\Qf{x̱ʼe}-\Rf{u}-	&\Qf{x̱ʼo}\Rf{o}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\Df{d}\If{i}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\Ff{s}\If{i}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\Df{d}\Ef{a}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\df{\Ff{s}}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\Ff{s}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\If{w}\Ef{a}\rlap{?}	&\Qf{x̱ʼo}\Rf{o}\rlap{?}\\
