...
\Qf{a}- expletive	&\Rf{u}-	&\Sf{x̱}-	&\Qf{a}-\Rf{u}-\Sf{x̱}-		&\Qf{a}\Sf{x̱}\Rf{w}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{a}\Sf{x̱}\Rf{w}\Df{d}\If{i}\rlap{?}		&\Qf{a}\Sf{x̱}\Rf{w}\Ff{s}\If{i}\rlap{?}		&\Qf{a}\Sf{x̱}\Rf{w}\Df{d}\Ef{a}\rlap{?}		&\Qf{a}\Sf{x̱}\Rf{w}\Ef{a}\df{\Ff{s}}\rlap{?}	&\Qf{a}\Sf{x̱}\Rf{w}\Ff{s}\Ef{a}\rlap{?}		&\Qf{a}\Sf{x̱}\Rf{w}\Ef{a}\If{a}\rlap{?}		&\Qf{a}\Sf{x̱}\Rf{w}\Ef{a}\rlap{?}\\
			&		&		&				&\Qf{o}\Rf{o}\Sf{x̱}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{o}\Rf{o}\Sf{x̱}\Df{d}\If{i}\rlap{?}		&\Qf{o}\Rf{o}\Sf{x̱}\Ff{s}\If{i}\rlap{?}		&\Qf{o}\Rf{o}\Sf{x̱}\Df{d}\Ef{a}\rlap{?}		&\Qf{o}\Rf{o}\Sf{x̱}\Ef{a}\df{\Ff{s}}\rlap{?}	&\Qf{o}\Rf{o}\Sf{x̱}\Ff{s}\Ef{a}\rlap{?}		&\Qf{o}\Rf{o}\Sf{x̱}\Ef{a}\If{a}\rlap{?}		&\Qf{o}\Rf{o}\Sf{x̱}\Ef{a}\\
...
\Qf{ji}- ‘hand’		&\Rf{u}-	&\Sf{x̱}-	&\Qf{ji}-\Rf{u}-\Sf{x̱}-		&\Qf{je}\Rf{e}\Sf{x̱}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Df{d}\If{i}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Ff{s}\If{i}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Df{d}\Ef{a}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Ef{a}\df{\Ff{s}}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Ff{s}\Ef{a}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Ef{a}\If{a}\rlap{?}	&\Qf{je}\Rf{e}\Sf{x̱}\Ef{a}\rlap{?}\\
			&		&		&				&\Qf{ji}\Sf{x̱}\Rf{w}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Df{d}\If{i}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Ff{s}\If{i}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Df{d}\Ef{a}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Ef{a}\df{\Ff{s}}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Ff{s}\Ef{a}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Ef{a}\If{a}\rlap{?}	&\Qf{ji}\Sf{x̱}\Rf{w}\Ef{a}\\
\Qf{tu}- ‘inside’	&\Rf{u}-	&\Sf{x̱}-	&\Qf{tu}-\Rf{u}-\Sf{x̱}-		&\Qf{to}\Rf{o}\Sf{x̱}\Df{d}\Ff{z}\If{i}		&\Qf{to}\Rf{o}\Sf{x̱}\Df{d}\If{i}		&\Qf{to}\Rf{o}\Sf{x̱}\Ff{s}\If{i}		&\Qf{to}\Rf{o}\Sf{x̱}\Df{d}\Ef{a}		&\Qf{to}\Rf{o}\Sf{x̱}\Ef{a}\df{\Ff{s}}		&\Qf{to}\Rf{o}\Sf{x̱}\Ff{s}\Ef{a}		&\Qf{to}\Rf{o}\Sf{x̱}\Ef{a}\If{a}		&\Qf{to}\Rf{o}\Sf{x̱}\Ef{a}\\
			&		&		&				&						&						&						&						&\Qf{tu}\Sf{x̱}\Rf{w}\Ef{a}\df{\Ff{s}}\rlap{?}	&						&\Qf{tu}\Sf{x̱}\Rf{w}\Ef{a}\If{a}\rlap{?}	&\Qf{tu}\Sf{x̱}\Rf{w}\Ef{a}\\
\bottomrule
\end{tabular}
...
\Qf{ʔa}- expletive	&\Rf{u}-	&\Sf{χ}-	&\Qf{ʔa}-\Rf{u}-\Sf{χ}-		&\Qf{ʔa}\Sf{χ}\Rf{ʷ}.\Df{t}\Ff{s}\If{i}\rlap{?}			&\Qf{ʔa}\Sf{χ}\Rf{ʷ}.\Df{t}\If{i}\rlap{?}		&\Qf{ʔa}\Sf{χ}\Rf{ʷ}.\Ff{s}\If{i}\rlap{?}		&\Qf{ʔa}\Sf{χ}\Rf{ʷ}.\Df{t}\Ef{a}\rlap{?}		&\Qf{ʔa}.\Sf{χ}\Rf{ʷ}\Ef{a}\df{\Ff{s}}\rlap{?}		&\Qf{ʔa}\Sf{χ}\Rf{ʷ}.\Ff{s}\Ef{a}\rlap{?}		&\Qf{ʔa}.\Sf{χ}\Rf{ʷ}\Ef{a}\If{ː}\rlap{?}	&\Qf{ʔa}.\Sf{χ}\Rf{ʷ}\Ef{a}\rlap{?}\\
			&		&		&				&\Qf{ʔu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Df{t}\Ff{s}\If{i}\rlap{?}		&\Qf{ʔu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Df{t}\If{i}\rlap{?}		&\Qf{ʔu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Ff{s}\If{i}\rlap{?}		&\Qf{ʔu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Df{t}\Ef{a}\rlap{?}		&\Qf{ʔu}\Rf{ː}.\Sf{χ}\Ef{a}\df{\Ff{s}}\rlap{?}		&\Qf{ʔu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Ff{s}\Ef{a}\rlap{?}		&\Qf{ʔu}\Rf{ː}.\Sf{χ}\Ef{a}\If{ː}\rlap{?}	&\Qf{ʔu}\Rf{ː}.\Sf{χ}\Ef{a}\\
...
\Qf{tʃi}- ‘hand’	&\Rf{u}-	&\Sf{χ}-	&\Qf{tʃi}-\Rf{u}-\Sf{χ}-	&\Qf{tʃi}\Rf{ː}\Sf{χ}.\Df{t}\Ff{s}\If{i}\rlap{?}		&\Qf{tʃi}\Rf{ː}\Sf{χ}.\Df{t}\If{i}\rlap{?}		&\Qf{tʃi}\Rf{ː}\Sf{χ}.\Ff{s}\If{i}\rlap{?}		&\Qf{tʃi}\Rf{ː}\Sf{χ}.\Df{t}\Ef{a}\rlap{?}		&\Qf{tʃi}\Rf{ː}.\Sf{χ}\Ef{a}\df{\Ff{s}}\rlap{?}		&\Qf{tʃi}\Rf{ː}\Sf{χ}.\Ff{s}\Ef{a}\rlap{?}		&\Qf{tʃi}\Rf{ː}.\Sf{χ}\Ef{a}\If{ː}\rlap{?}	&\Qf{tʃi}\Rf{ː}.\Sf{χ}\Ef{a}\rlap{?}\\
			&		&		&				&\Qf{tʃi}\Sf{χ}\Rf{ʷ}.\Df{t}\Ff{s}\If{i}\rlap{?}		&\Qf{tʃi}\Sf{χ}\Rf{ʷ}.\Df{t}\If{i}\rlap{?}		&\Qf{tʃi}\Sf{χ}\Rf{ʷ}.\Ff{s}\If{i}\rlap{?}		&\Qf{tʃi}\Sf{χ}\Rf{ʷ}.\Df{t}\Ef{a}\rlap{?}		&\Qf{tʃi}.\Sf{χ}\Rf{ʷ}\Ef{a}\df{\Ff{s}}\rlap{?}		&\Qf{tʃi}\Sf{χ}\Rf{ʷ}.\Ff{s}\Ef{a}\rlap{?}		&\Qf{tʃi}.\Sf{χ}\Rf{ʷ}\Ef{a}\If{ː}\rlap{?}	&\Qf{tʃi}.\Sf{χ}\Rf{ʷ}\Ef{a}\\
\Qf{tʰu}- ‘inside’	&\Rf{u}-	&\Sf{χ}\Rf{ʷ}-	&\Qf{tʰu}-\Rf{u}-\Sf{χ}\Rf{ʷ}-	&\Qf{tʰu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Df{t}\Ff{s}\If{i}			&\Qf{tʰu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Df{t}\If{i}		&\Qf{tʰu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Ff{s}\If{i}		&\Qf{tʰu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Df{t}\Ef{a}		&\Qf{tʰu}\Rf{ː}.\Sf{χ}\Ef{a}\df{\Ff{s}}			&\Qf{tʰu}\Rf{ː}\Sf{χ}\Rf{ʷ}.\Ff{s}\Ef{a}		&\Qf{tʰu}\Rf{ː}.\Sf{χ}\Ef{a}\If{ː}		&\Qf{tʰu}\Rf{ː}.\Sf{χ}\Ef{a}\\
			&		&		&				&								&							&							&							&\Qf{tu}.\Sf{χ}\Rf{ʷ}\Ef{a}\df{\Ff{s}}\rlap{?}		&							&\Qf{tu}.\Sf{χ}\Rf{ʷ}\Ef{a}\If{ː}\rlap{?}	&\Qf{tu}.\Sf{χ}\Rf{ʷ}\Ef{a}\\
\bottomrule
\end{tabular}
...
\Qf{a}- expletive	&\Rf{u}-	&\Sf{tu}-	&\Qf{a}-\Rf{u}-\Sf{tu}-		&\Qf{a}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{a}\Sf{tu}\Df{d}\If{i}		&\Qf{a}\Sf{tu}\Ff{s}\If{i}		&\Qf{a}\Sf{tu}\Df{d}\Ef{a}		&\Qf{a}\Sf{too}\df{\Ff{s}}		&\Qf{a}\Sf{tu}\Ff{s}\Ef{a}		&\Qf{a}\Sf{tu}\If{w}\Ef{a}		&\Qf{a}\Sf{too}\\
...
\Qf{ʔa}- expletive	&\Rf{u}-	&\Sf{tʰu}-	&\Qf{ʔa}-\Rf{u}-\Sf{tʰu}-	&\Qf{ʔa}.\Sf{tʰu}.\Df{t}\Ff{s}\If{i}\rlap{?}	&\Qf{ʔa}.\Sf{tʰu}.\Df{t}\If{i}		&\Qf{ʔa}.\Sf{tʰu}.\Ff{s}\If{i}		&\Qf{ʔa}.\Sf{tʰu}.\Df{t}\Ef{a}		&\Qf{ʔa}.\Sf{tʰuː}\df{\Ff{s}}		&\Qf{ʔa}.\Sf{tʰu}.\Ff{s}\Ef{a}		&\Qf{ʔa}.\Sf{tʰu}.\If{w}\Ef{a}		&\Qf{ʔa}.\Sf{tʰuː}\\
...
%%%
\clearpage
\subsection{\textit{N}-conjugation prefix \textit{n-} with irrealis \textit{u-}}
...
%%%
\subsection{\textit{G̱}-conjugation prefix \textit{g̱-} with irrealis \textit{u-}}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{d}-\Ff{s}-\If{i}\rlap{-}				&\Df{d}-\If{i}\rlap{-}				&\Ff{s}-\If{i}\rlap{-}				&\Df{d}-				&\Df{d}-\Ff{s}\rlap{-}			&\Ff{s}-				&\If{i}-				&—\\
\midrule
—			&\Af{g}-	&\Sf{tu}-	&\Af{g}-\Sf{tu}-		&\Af{g}\Ef{a}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Af{g}\Ef{a}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Af{g}\Ef{a}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Af{g}\Ef{a}\Sf{tu}\Df{d}\Ef{a}	&\Af{g}\Ef{a}\Sf{too}\df{\Ff{s}}	&\Af{g}\Ef{a}\Sf{tu}\Ff{s}\Ef{a}	&\Af{g}\Ef{a}\Sf{tu}\If{w}\Ef{a}	&\Af{g}\Ef{a}\Sf{too}\\
\Qf{a}- expletive	&\Af{g}-	&\Sf{tu}-	&\Qf{a}-\Af{g}-\Sf{tu}-		&\Qf{a}\Af{k}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{a}\Af{k}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{a}\Af{k}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{a}\Af{k}\Sf{tu}\Df{d}\Ef{a}	&\Qf{a}\Af{k}\Sf{too}\df{\Ff{s}}	&\Qf{a}\Af{k}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{a}\Af{k}\Sf{tu}\If{w}\Ef{a}	&\Qf{a}\Af{k}\Sf{too}\\
\Qf{ka}- qualifier	&\Af{g}-	&\Sf{tu}-	&\Qf{ka}-\Af{g}-\Sf{tu}-	&\Qf{ka}\Af{k}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{ka}\Af{k}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{ka}\Af{k}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{ka}\Af{k}\Sf{tu}\Df{d}\Ef{a}	&\Qf{ka}\Af{k}\Sf{too}\df{\Ff{s}}	&\Qf{ka}\Af{k}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{ka}\Af{k}\Sf{tu}\If{w}\Ef{a}	&\Qf{ka}\Af{k}\Sf{too}\\
\Qf{x̱ʼe}- ‘mouth’	&\Af{g}-	&\Sf{tu}-	&\Qf{x̱ʼe}-\Af{g}-\Sf{tu}-	&\Qf{x̱ʼa}\Af{k}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{k}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{k}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{k}\Sf{tu}\Df{d}\Ef{a}	&\Qf{x̱ʼa}\Af{k}\Sf{too}\df{\Ff{s}}	&\Qf{x̱ʼa}\Af{k}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{x̱ʼa}\Af{k}\Sf{tu}\If{w}\Ef{a}	&\Qf{x̱ʼa}\Af{k}\Sf{too}\\
\Qf{ji}- ‘hand’		&\Af{g}-	&\Sf{tu}-	&\Qf{ji}-\Af{g}-\Sf{tu}-	&\Qf{ji}\Af{k}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{ji}\Af{k}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{ji}\Af{k}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{ji}\Af{k}\Sf{tu}\Df{d}\Ef{a}	&\Qf{ji}\Af{k}\Sf{too}\df{\Ff{s}}	&\Qf{ji}\Af{k}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{ji}\Af{k}\Sf{tu}\If{w}\Ef{a}	&\Qf{ji}\Af{k}\Sf{too}\\
\Qf{tu}- ‘inside’	&\Af{g}-	&\Sf{tu}-	&\Qf{tu}-\Af{g}-\Sf{tu}-	&\Qf{tu}\Af{k}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{tu}\Af{k}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{tu}\Af{k}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{tu}\Af{k}\Sf{tu}\Df{d}\Ef{a}	&\Qf{tu}\Af{k}\Sf{too}\df{\Ff{s}}	&\Qf{tu}\Af{k}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{tu}\Af{k}\Sf{tu}\If{w}\Ef{a}	&\Qf{tu}\Af{k}\Sf{too}\\
\bottomrule
\end{tabular}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{t}-\Ff{s}-\If{i}\rlap{-}				&\Df{t}-\If{i}\rlap{-}				&\Ff{s}-\If{i}\rlap{-}				&\Df{t}-				&\Df{t}-\Ff{s}\rlap{-}			&\Ff{s}-				&\If{i}-					&—\\
\midrule
—			&\Af{k}-	&\Sf{i}-	&\Af{k}-\Sf{i}-			&\Af{k}\Sf{i}.\Df{t}\Ff{s}\If{i}\rlap{?}		&\Af{k}\Sf{i}.\Df{t}\If{i}\rlap{?}		&\Af{k}\Sf{i}.\Ff{s}\If{i}\rlap{?}		&\Af{k}\Sf{i}.\Df{t}\Ef{a}		&\Af{k}\Sf{iː}\df{\Ff{s}}		&\Af{k}\Sf{i}.\Ff{s}\Ef{a}		&\Af{k}\Sf{i}.\If{j}\Ef{a}\rlap{?}		&\Af{k}\Sf{iː}\\
\Qf{ʔa}- expletive	&\Af{k}-	&\Sf{i}-	&\Qf{ʔa}-\Af{k}-\Sf{i}-		&\Qf{ʔa}.\Af{k}\Sf{i}.\Df{t}\Ff{s}\If{i}\rlap{?}	&\Qf{ʔa}.\Af{k}\Sf{i}.\Df{t}\If{i}\rlap{?}	&\Qf{ʔa}.\Af{k}\Sf{i}.\Ff{s}\If{i}\rlap{?}	&\Qf{ʔa}.\Af{k}\Sf{i}.\Df{t}\Ef{a}	&\Qf{ʔa}.\Af{k}\Sf{iː}\df{\Ff{s}}	&\Qf{ʔa}.\Af{k}\Sf{i}.\Ff{s}\Ef{a}	&\Qf{ʔa}.\Af{k}\Sf{i}.\If{j}\Ef{a}\rlap{?}	&\Qf{ʔa}.\Af{k}\Sf{iː}\\
\Qf{kʰa}- qualifier	&\Af{k}-	&\Sf{i}-	&\Qf{kʰa}-\Af{k}-\Sf{i}-	&\Qf{kʰa}.\Af{k}\Sf{i}.\Df{t}\Ff{s}\If{i}\rlap{?}	&\Qf{kʰa}.\Af{k}\Sf{i}.\Df{t}\If{i}\rlap{?}	&\Qf{kʰa}.\Af{k}\Sf{i}.\Ff{s}\If{i}\rlap{?}	&\Qf{kʰa}.\Af{k}\Sf{i}.\Df{t}\Ef{a}	&\Qf{kʰa}.\Af{k}\Sf{iː}\df{\Ff{s}}	&\Qf{kʰa}.\Af{k}\Sf{i}.\Ff{s}\Ef{a}	&\Qf{kʰa}.\Af{k}\Sf{i}.\If{j}\Ef{a}\rlap{?}	&\Qf{kʰa}.\Af{k}\Sf{iː}\\
\Qf{χʼe}- ‘mouth’	&\Af{k}-	&\Sf{i}-	&\Qf{χʼe}-\Af{k}-\Sf{i}-	&\Qf{χʼa}.\Af{k}\Sf{i}.\Df{t}\Ff{s}\If{i}\rlap{?}	&\Qf{χʼa}.\Af{k}\Sf{i}.\Df{t}\If{i}\rlap{?}	&\Qf{χʼa}.\Af{k}\Sf{i}.\Ff{s}\If{i}\rlap{?}	&\Qf{χʼa}.\Af{k}\Sf{i}.\Df{t}\Ef{a}	&\Qf{χʼa}.\Af{k}\Sf{iː}\df{\Ff{s}}	&\Qf{χʼa}.\Af{k}\Sf{i}.\Ff{s}\Ef{a}	&\Qf{χʼa}.\Af{k}\Sf{i}.\If{j}\Ef{a}\rlap{?}	&\Qf{χʼa}.\Af{k}\Sf{iː}\\
\Qf{tʃi}- ‘hand’	&\Af{k}-	&\Sf{i}-	&\Qf{tʃi}-\Af{k}-\Sf{i}-	&\Qf{tʃi}.\Af{k}\Sf{i}.\Df{t}\Ff{s}\If{i}\rlap{?}	&\Qf{tʃi}.\Af{k}\Sf{i}.\Df{t}\If{i}\rlap{?}	&\Qf{tʃi}.\Af{k}\Sf{i}.\Ff{s}\If{i}\rlap{?}	&\Qf{tʃi}.\Af{k}\Sf{i}.\Df{t}\Ef{a}	&\Qf{tʃi}.\Af{k}\Sf{iː}\df{\Ff{s}}	&\Qf{tʃi}.\Af{k}\Sf{i}.\Ff{s}\Ef{a}	&\Qf{tʃi}.\Af{k}\Sf{i}.\If{j}\Ef{a}\rlap{?}	&\Qf{tʃi}.\Af{k}\Sf{iː}\\
\Qf{tʰu}- ‘inside’	&\Af{k}-	&\Sf{i}-	&\Qf{tʰu}-\Af{k}-\Sf{i}-	&\Qf{tʰu}.\Af{k}\Sf{i}.\Df{t}\Ff{s}\If{i}\rlap{?}	&\Qf{tʰu}.\Af{k}\Sf{i}.\Df{t}\If{i}\rlap{?}	&\Qf{tʰu}.\Af{k}\Sf{i}.\Ff{s}\If{i}\rlap{?}	&\Qf{tʰu}.\Af{k}\Sf{i}.\Df{t}\Ef{a}	&\Qf{tʰu}.\Af{k}\Sf{iː}\df{\Ff{s}}	&\Qf{tʰu}.\Af{k}\Sf{i}.\Ff{s}\Ef{a}	&\Qf{tʰu}.\Af{k}\Sf{i}.\If{j}\Ef{a}\rlap{?}	&\Qf{tʰu}.\Af{k}\Sf{iː}\\
\bottomrule
\end{tabular}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{d}-\Ff{s}-\If{i}\rlap{-}				&\Df{d}-\If{i}\rlap{-}				&\Ff{s}-\If{i}\rlap{-}				&\Df{d}-				&\Df{d}-\Ff{s}\rlap{-}			&\Ff{s}-				&\If{i}-					&—\\
\midrule
—			&\Af{g}-	&\Sf{yi}-	&\Af{g}-\Sf{yi}-		&\Af{g}\Ef{a}\Sf{y}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Af{g}\Ef{a}\Sf{y}\Df{d}\If{i}\rlap{?}		&\Af{g}\Ef{a}\Sf{y}\Ff{s}\If{i}\rlap{?}		&\Af{g}\Ef{a}\Sf{y}\Df{d}\Ef{a}		&\Af{g}\Ef{a}\Sf{yi}\df{\Ff{s}}		&\Af{g}\Ef{a}\Sf{y}\Ff{s}\Ef{a}		&\Af{g}\Ef{a}\Sf{yee}\If{y}\rlap{?}		&\Af{g}\Ef{a}\Sf{y}\\
\Qf{a}- expletive	&\Af{g}-	&\Sf{yi}-	&\Qf{a}-\Af{g}-\Sf{yi}-		&\Qf{a}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{a}\Af{g}\Ef{a}\Sf{y}\Df{d}\If{i}\rlap{?}	&\Qf{a}\Af{g}\Ef{a}\Sf{y}\Ff{s}\If{i}\rlap{?}	&\Qf{a}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ef{a}	&\Qf{a}\Af{g}\Ef{a}\Sf{yi}\df{\Ff{s}}	&\Qf{a}\Af{g}\Ef{a}\Sf{y}\Ff{s}\Ef{a}	&\Qf{a}\Af{g}\Ef{a}\Sf{yee}\If{y}\rlap{?}	&\Qf{a}\Af{g}\Ef{a}\Sf{y}\\
\Qf{ka}- qualifier	&\Af{g}-	&\Sf{yi}-	&\Qf{ka}-\Af{g}-\Sf{yi}-	&\Qf{ka}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{ka}\Af{g}\Ef{a}\Sf{y}\Df{d}\If{i}\rlap{?}	&\Qf{ka}\Af{g}\Ef{a}\Sf{y}\Ff{s}\If{i}\rlap{?}	&\Qf{ka}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ef{a}	&\Qf{ka}\Af{g}\Ef{a}\Sf{yi}\df{\Ff{s}}	&\Qf{ka}\Af{g}\Ef{a}\Sf{y}\Ff{s}\Ef{a}	&\Qf{ka}\Af{g}\Ef{a}\Sf{yee}\If{y}\rlap{?}	&\Qf{ka}\Af{g}\Ef{a}\Sf{y}\\
\Qf{x̱ʼe}- ‘mouth’	&\Af{g}-	&\Sf{yi}-	&\Qf{x̱ʼe}-\Af{g}-\Sf{yi}-	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{y}\Df{d}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{y}\Ff{s}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ef{a}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{yi}\df{\Ff{s}}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{y}\Ff{s}\Ef{a}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{yee}\If{y}\rlap{?}	&\Qf{x̱ʼa}\Af{g}\Ef{a}\Sf{y}\\
\Qf{ji}- ‘hand’		&\Af{g}-	&\Sf{yi}-	&\Qf{ji}-\Af{g}-\Sf{yi}-	&\Qf{ji}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{ji}\Af{g}\Ef{a}\Sf{y}\Df{d}\If{i}\rlap{?}	&\Qf{ji}\Af{g}\Ef{a}\Sf{y}\Ff{s}\If{i}\rlap{?}	&\Qf{ji}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ef{a}	&\Qf{ji}\Af{g}\Ef{a}\Sf{yi}\df{\Ff{s}}	&\Qf{ji}\Af{g}\Ef{a}\Sf{y}\Ff{s}\Ef{a}	&\Qf{ji}\Af{g}\Ef{a}\Sf{yee}\If{y}\rlap{?}	&\Qf{ji}\Af{g}\Ef{a}\Sf{y}\\
\Qf{tu}- ‘inside’	&\Af{g}-	&\Sf{yi}-	&\Qf{tu}-\Af{g}-\Sf{yi}-	&\Qf{tu}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{tu}\Af{g}\Ef{a}\Sf{y}\Df{d}\If{i}\rlap{?}	&\Qf{tu}\Af{g}\Ef{a}\Sf{y}\Ff{s}\If{i}\rlap{?}	&\Qf{tu}\Af{g}\Ef{a}\Sf{y}\Df{d}\Ef{a}	&\Qf{tu}\Af{g}\Ef{a}\Sf{yi}\df{\Ff{s}}	&\Qf{tu}\Af{g}\Ef{a}\Sf{y}\Ff{s}\Ef{a}	&\Qf{tu}\Af{g}\Ef{a}\Sf{yee}\If{y}\rlap{?}	&\Qf{tu}\Af{g}\Ef{a}\Sf{y}\\
\bottomrule
\end{tabular}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{t}-\Ff{s}-\If{i}\rlap{-}					&\Df{t}-\If{i}\rlap{-}	&\Ff{s}-\If{i}\rlap{-}	&\Df{t}-	&\Df{t}-\Ff{s}\rlap{-}				&\Ff{s}-	&\If{i}-						&—\\
\midrule
—			&\Af{k}-	&\Sf{tu}-	&\Af{k}-\Sf{tu}-		&\Af{k}\Ef{a}.\Sf{tu}.\Df{t}\Ff{s}\If{i}\rlap{?}		&⁎			&⁎			&⁎		&\Af{k}\Ef{a}.\Sf{tu}\df{\Ff{s}}		&⁎		&\Af{k}\Ef{a}.\Sf{tu}.\If{w}\Ef{a}\rlap{?}		&\Af{k}\Ef{a}.\Sf{tu}\\
\Qf{ʔa}- expletive	&\Af{k}-	&\Sf{tu}-	&\Qf{ʔa}-\Af{k}-\Sf{tu}-	&\Qf{ʔa}\Af{k}.\Sf{tu}.\Df{t}\Ff{s}\If{i}\rlap{?}		&⁎			&⁎			&⁎		&\Qf{ʔa}\Af{k}.\Sf{tu}\df{\Ff{s}}		&⁎		&\Qf{ʔa}\Af{k}.\Sf{tu}.\If{w}\Ef{a}\rlap{?}		&\Qf{ʔa}\Af{k}.\Sf{tu}\\
\Qf{kʰa}- qualifier	&\Af{k}-	&\Sf{tu}-	&\Qf{kʰa}-\Af{k}-\Sf{tu}-	&\Qf{kʰa}\Af{k}.\Sf{tu}.\Df{t}\Ff{s}\If{i}\rlap{?}		&⁎			&⁎			&⁎		&\Qf{kʰa}\Af{k}.\Sf{tu}\df{\Ff{s}}		&⁎		&\Qf{kʰa}\Af{k}.\Sf{tu}.\If{w}\Ef{a}\rlap{?}		&\Qf{kʰa}\Af{k}.\Sf{tu}\\
\Qf{χʼe}- ‘mouth’	&\Af{k}-	&\Sf{tu}-	&\Qf{χʼe}-\Af{k}-\Sf{tu}-	&\Qf{χʼa}\Af{k}.\Sf{tu}.\Df{t}\Ff{s}\If{i}\rlap{?}		&⁎			&⁎			&⁎		&\Qf{χʼa}\Af{k}.\Sf{tu}\df{\Ff{s}}		&⁎		&\Qf{χʼa}\Af{k}.\Sf{tu}.\If{w}\Ef{a}\rlap{?}		&\Qf{χʼa}\Af{k}.\Sf{tu}\\
\Qf{tʃi}- ‘hand’	&\Af{k}-	&\Sf{tu}-	&\Qf{tʃi}-\Af{k}-\Sf{tu}-	&\Qf{tʃi}\Af{k}.\Sf{tu}.\Df{t}\Ff{s}\If{i}\rlap{?}		&⁎			&⁎			&⁎		&\Qf{tʃi}\Af{k}.\Sf{tu}\df{\Ff{s}}		&⁎		&\Qf{tʃi}\Af{k}.\Sf{tu}.\If{w}\Ef{a}\rlap{?}		&\Qf{tʃi}\Af{k}.\Sf{tu}\\
\Qf{tʰu}- ‘inside’	&\Af{k}-	&\Sf{tu}-	&\Qf{tʰu}-\Af{k}-\Sf{tu}-	&\Qf{tʰu}\Af{k}\Qf{ʷ}.\Sf{tu}.\Df{t}\Ff{s}\If{i}\rlap{?}	&⁎			&⁎			&⁎		&\Qf{tʰu}\Af{k}\Qf{ʷ}.\Sf{tu}\df{\Ff{s}}	&⁎		&\Qf{tʰu}\Af{k}\Qf{ʷ}.\Sf{tu}.\If{w}\Ef{a}\rlap{?}	&\Qf{tʰu}\Af{k}\Qf{ʷ}.\Sf{tu}\\
\bottomrule
\end{tabular}
...
%%%
\subsection{\textit{G}-conjugation prefix \textit{g-} with irrealis \textit{u-}}
