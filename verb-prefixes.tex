...
\FIXME{Colour key — \Qf{object or qualifier/incorporate}, \Rf{irrealis}, \Af{aspect}, \Mf{modality}, \Sf{subject}, \Df{classifier \fm{d-} prefix}, \Ff{classifier \fm{s-}/\fm{l-}/\fm{sh-} prefix}, \If{classifier \fm{i-} prefix}, \Ef{epenthesis}, \df{\textit{d-} prefix deletion}, \Xf{other deletion}}
\end{multicols}
