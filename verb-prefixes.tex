...
% irrealis
\definecolor{Rcolor}{rgb}{0.45,0.45,0.00}
% aspect/conjugation
...
It details all the basic patterns of possible combinations of verb prefixes including the classifier prefixes
(\fm{\Df{d}-}, \fm{\Ff{s}-}/\fm{\Ff{l}-}/\fm{\Ff{sh}-}, \fm{\If{i}-}),
the subject prefixes (\fm{\Sf{x̱}-}, \fm{\Sf{tu}-}, \fm{\Sf{i}-}, \fm{\Sf{yi}-}, \fm{\Sf{du}-}),
the aspect and conjugation prefixes (\fm{\Af{wu}-}, \fm{\Af{u}-}, \fm{\Af{∅}}, \fm{\Af{n}-}, \fm{\Af{g̱}-}, \fm{\Af{g}-}),
the irrealis prefixes (\fm{\Rf{u}-}, \fm{\Rf{w}-}),
the modality prefix (\fm{\Mf{g̱}-}),
the argument/expletive prefix (\fm{\Qf{a}-}),
and the four vowel patterns of the CV disjunct prefixes (\fm{\Qf{ka}-}, \fm{\Qf{x̱ʼe}-}, \fm{\Qf{ji}-}, \fm{\Qf{tu}-}).
...
The first pattern is unmarked aspect which covers forms that lack an overt aspect prefix, i.e.\ neither a perfective prefix (\fm{wu-}, \fm{u-}) nor an overt conjugation prefix (\fm{n-}, \fm{g̱-}, \fm{g-}).
The next three are patterns with each of the overt conjugation prefixes \fm{n-}, \fm{g̱-}, and \fm{g-}.
Following these are the distinct patterns of the perfective aspect and the prospective aspect.

Each section is divided up into subsections reflecting the prefixes that accompany the aspectual prefixes, namely the irrealis prefix (\fm{u-}) and the modality prefix (\fm{g̱-}).
The first subsection gives forms with the irrealis prefix \fm{u-}, the second subsection gives forms with the modality prefix \fm{g̱-}, and the third subsection gives forms with both.
...
For the prospective aspect this is because both the irrealis prefix \fm{w-} and the modality prefix \fm{g̱-} are obligatory in all forms.
...
The next two pairs of tables give the first person singular subject \fm{x̱-} ‘I’ and first person plural subject \fm{tu-} ‘we’.
Then the following two pairs of tables give the second person singular subject \fm{i-} ‘you sg.’ and second person plural subject \fm{yi-} ‘you guys’.
Finally, the last pair of tables gives the fourth person (indefinite, nonspecific) human subject \fm{du-} ‘someone, people, they’.
...
\FIXME{Why we use \fm{ka-}, \fm{tu-}, \fm{ji-}, \fm{x̱ʼe-}. Other prefixes should be similar.}

\FIXME{Prefixes like \fm{waḵ-} will have no effect. Prefixes like \fm{daa-} will behave like \fm{ka-}.}

\FIXME{Why we include \fm{a-} even when it’s not third person – it’s possible as an expletive or ‘dummy’ object.}
...
\FIXME{This is not the case for Southern varieties, but we aren’t listing them yet so there’s no possible confusion.}

\FIXME{Discuss questioned forms. Either they are unattested or they are possibly – but not certainly – ungrammatical.
Combinations of prefixes that are known to be ungrammatical are indicated with ‘⁎’.}

\FIXME{Key — \Qf{object or qualifier/incorporate}, \Rf{irrealis}, \Af{aspect}, \Mf{modality}, \Sf{subject}, \Df{classifier \fm{d-} prefix}, \Ff{classifier \fm{s-}/\fm{l-}/\fm{sh-} prefix}, \If{classifier \fm{i-} prefix}, \Ef{epenthesis}, \df{\textit{d-} prefix deletion}, \Xf{other deletion}}
...
\FIXME{List of environments: imperfective, imperative, realizational, hortative, etc.}
\end{multicols}
...
\Qf{a}- expletive	&\Af{g̱}-	&\Sf{tu}-	&\Qf{a}-\Af{g̱}-\Sf{tu}-		&\Qf{a}\Af{x̱}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{a}\Af{x̱}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{a}\Af{x̱}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{a}\Af{x̱}\Sf{tu}\Df{d}\Ef{a}	&\Qf{a}\Af{x̱}\Sf{too}\df{\Ff{s}}	&\Qf{a}\Af{x̱}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{a}\Af{x̱}\Sf{tu}\If{w}\Ef{a}	&\Qf{a}\Af{g̱}\Ef{a}\Sf{too}\\
\Qf{ka}- qualifier	&\Af{g̱}-	&\Sf{tu}-	&\Qf{ka}-\Af{g̱}-\Sf{tu}-	&\Qf{ka}\Af{x̱}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{ka}\Af{x̱}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{ka}\Af{x̱}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{ka}\Af{x̱}\Sf{tu}\Df{d}\Ef{a}	&\Qf{ka}\Af{x̱}\Sf{too}\df{\Ff{s}}	&\Qf{ka}\Af{x̱}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{ka}\Af{x̱}\Sf{tu}\If{w}\Ef{a}	&\Qf{ka}\Af{g̱}\Ef{a}\Sf{too}\\
\Qf{x̱ʼe}- ‘mouth’	&\Af{g̱}-	&\Sf{tu}-	&\Qf{x̱ʼe}-\Af{g̱}-\Sf{tu}-	&\Qf{x̱'a}\Af{x̱}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{x̱}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{x̱}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Af{x̱}\Sf{tu}\Df{d}\Ef{a}	&\Qf{x̱ʼa}\Af{x̱}\Sf{too}\df{\Ff{s}}	&\Qf{x̱ʼa}\Af{x̱}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{x̱ʼa}\Af{x̱}\Sf{tu}\If{w}\Ef{a}	&\Qf{x̱ʼa}\Af{g̱}\Ef{a}\Sf{too}\\
\Qf{ji}- ‘hand’		&\Af{g̱}-	&\Sf{tu}-	&\Qf{ji}-\Af{g̱}-\Sf{tu}-	&\Qf{ji}\Af{x̱}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{ji}\Af{x̱}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{ji}\Af{x̱}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{ji}\Af{x̱}\Sf{tu}\Df{d}\Ef{a}	&\Qf{ji}\Af{x̱}\Sf{too}\df{\Ff{s}}	&\Qf{ji}\Af{x̱}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{ji}\Af{x̱}\Sf{tu}\If{w}\Ef{a}	&\Qf{ji}\Af{g̱}\Ef{a}\Sf{too}\\
\Qf{tu}- ‘inside’	&\Af{g̱}-	&\Sf{tu}-	&\Qf{tu}-\Af{g̱}-\Sf{tu}-	&\Qf{tu}\Af{x̱}\Sf{tu}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Qf{tu}\Af{x̱}\Sf{tu}\Df{d}\If{i}\rlap{?}	&\Qf{tu}\Af{x̱}\Sf{tu}\Ff{s}\If{i}\rlap{?}	&\Qf{tu}\Af{x̱}\Sf{tu}\Df{d}\Ef{a}	&\Qf{tu}\Af{x̱}\Sf{too}\df{\Ff{s}}	&\Qf{tu}\Af{x̱}\Sf{tu}\Ff{s}\Ef{a}	&\Qf{tu}\Af{x̱}\Sf{tu}\If{w}\Ef{a}	&\Qf{tu}\Af{g̱}\Ef{a}\Sf{too}\\
\bottomrule
\end{tabular}
