...
\begin{multicols}{2}
Unmarked aspect is any form without an overt aspect prefix, i.e.\ no perfective prefix (\fm{wu-}, \fm{u-}) and no overt conjugation prefix (\fm{n-}, \fm{g̱-}, \fm{g-}).
The simplest case of unmarked aspect is the imperfective aspect form of most activity and state verbs.
(There are exceptions such as extensional state imperfectives that select a non-\fm{∅} conjugation prefix.)
Another case of unmarked aspect is the imperative mood form of verbs that belong to the \fm{∅}-conjugation class, where the form selects a conjugation prefix but this prefix is covert (i.e.\ \fm{∅}).
\end{multicols}
