...
% aspect/conjugation
\definecolor{Acolor}{rgb}{0.66,0.33,0.00}
% modality
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{d}-\Ff{s}-\If{i}\rlap{-}			&\Df{d}-\If{i}\rlap{-}				&\Ff{s}-\If{i}\rlap{-}				&\Df{d}-				&\Df{d}-\Ff{s}\rlap{-}			&\Ff{s}-				&\If{i}-			&—\\
\midrule
—			&\Af{g̱}-	&\Sf{x̱}-	&\Af{g̱}-\Sf{x̱}-			&\Sf{ḵ}\Ef{a}\Df{d}\Ff{z}\If{i}\rlap{?}		&\Sf{ḵ}\Ef{a}\Df{d}\If{i}\rlap{?}		&\Sf{ḵ}\Ef{a}\Ff{s}\If{i}\rlap{?}		&\Sf{ḵ}\Ef{a}\Df{d}\Ef{a}		&\Sf{ḵ}\Ef{a}\df{\Ff{s}}		&\Sf{ḵ}\Ef{a}\Ff{s}\Ef{a}		&\Sf{ḵ}\Ef{a}\If{a}		&\Sf{ḵ}\Ef{a}\\
\Qf{a}- expletive	&\Af{g̱}-	&\Sf{x̱}-	&\Qf{a}-\Af{g̱}-\Sf{x̱}-		&\Qf{a}\Sf{ḵ}\Ef{a}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{a}\Sf{ḵ}\Ef{a}\Df{d}\If{i}\rlap{?}		&\Qf{a}\Sf{ḵ}\Ef{a}\Ff{s}\If{i}\rlap{?}		&\Qf{a}\Sf{ḵ}\Ef{a}\Df{d}\Ef{a}		&\Qf{a}\Sf{ḵ}\Ef{a}\df{\Ff{s}}		&\Qf{a}\Sf{ḵ}\Ef{a}\Ff{s}\Ef{a}		&\Qf{a}\Sf{ḵ}\Ef{a}\If{a}	&\Qf{a}\Sf{ḵ}\Ef{a}\\
\Qf{ka}- qualifier	&\Af{g̱}-	&\Sf{x̱}-	&\Qf{ka}-\Af{g̱}-\Sf{x̱}-		&\Qf{ka}\Sf{ḵ}\Ef{a}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{ka}\Sf{ḵ}\Ef{a}\Df{d}\If{i}\rlap{?}	&\Qf{ka}\Sf{ḵ}\Ef{a}\Ff{s}\If{i}\rlap{?}	&\Qf{ka}\Sf{ḵ}\Ef{a}\Df{d}\Ef{a}	&\Qf{ka}\Sf{ḵ}\Ef{a}\df{\Ff{s}}		&\Qf{ka}\Sf{ḵ}\Ef{a}\Ff{s}\Ef{a}	&\Qf{ka}\Sf{ḵ}\Ef{a}\If{a}	&\Qf{ka}\Sf{ḵ}\Ef{a}\\
\Qf{tu}- ‘inside’	&\Af{g̱}-	&\Sf{x̱}-	&\Qf{tu}-\Af{g̱}-\Sf{x̱}-		&\Qf{tu}\Sf{ḵ}\Ef{a}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{tu}\Sf{ḵ}\Ef{a}\Df{d}\If{i}\rlap{?}	&\Qf{tu}\Sf{ḵ}\Ef{a}\Ff{s}\If{i}\rlap{?}	&\Qf{tu}\Sf{ḵ}\Ef{a}\Df{d}\Ef{a}	&\Qf{tu}\Sf{ḵ}\Ef{a}\df{\Ff{s}}		&\Qf{tu}\Sf{ḵ}\Ef{a}\Ff{s}\Ef{a}	&\Qf{tu}\Sf{ḵ}\Ef{a}\If{a}	&\Qf{tu}\Sf{ḵ}\Ef{a}\\
\Qf{ji}- ‘hand’		&\Af{g̱}-	&\Sf{x̱}-	&\Qf{ji}-\Af{g̱}-\Sf{x̱}-		&\Qf{ji}\Sf{ḵ}\Ef{a}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{ji}\Sf{ḵ}\Ef{a}\Df{d}\If{i}\rlap{?}	&\Qf{ji}\Sf{ḵ}\Ef{a}\Ff{s}\If{i}\rlap{?}	&\Qf{ji}\Sf{ḵ}\Ef{a}\Df{d}\Ef{a}	&\Qf{ji}\Sf{ḵ}\Ef{a}\df{\Ff{s}}		&\Qf{ji}\Sf{ḵ}\Ef{a}\Ff{s}\Ef{a}	&\Qf{ji}\Sf{ḵ}\Ef{a}\If{a}	&\Qf{ji}\Sf{ḵ}\Ef{a}\\
\Qf{x̱ʼe}- ‘mouth’	&\Af{g̱}-	&\Sf{x̱}-	&\Qf{x̱ʼe}-\Af{g̱}-\Sf{x̱}-	&\Qf{x̱'a}\Sf{ḵ}\Ef{a}\Df{d}\Ff{z}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\Df{d}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\Ff{s}\If{i}\rlap{?}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\Df{d}\Ef{a}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\df{\Ff{s}}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\Ff{s}\Ef{a}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\If{a}	&\Qf{x̱ʼa}\Sf{ḵ}\Ef{a}\\
\bottomrule
\end{tabular}
