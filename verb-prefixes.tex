...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{d}-\Ff{s}-\If{i}\rlap{-}	&\Df{d}-\If{i}\rlap{-}	&\Ff{s}-\If{i}\rlap{-}	&\Df{d}-	&\Df{d}-\Ff{s}\rlap{-}			&\Ff{s}-	&\If{i}-	&—\\
\midrule                                                                                                                                                                                                                                                        
—			&\Af{g̱}-	&\Sf{du}-	&\Af{g̱}-\Sf{du}-		&⁎				&⁎			&⁎			&⁎		&\Af{g̱}\Ef{a}\Sf{du}\df{\Ff{s}}		&⁎		&⁎		&\Af{g̱}\Ef{a}\Sf{du}\\
\Qf{a}- expletive	&\Af{g̱}-	&\Sf{du}-	&\Qf{a}-\Af{g̱}-\Sf{du}-		&⁎				&⁎			&⁎			&⁎		&\Qf{a}\Af{x̱}\Sf{du}\df{\Ff{s}}		&⁎		&⁎		&\Qf{a}\Af{x̱}\Sf{du}\\
\Qf{ka}- qualifier	&\Af{g̱}-	&\Sf{du}-	&\Qf{ka}-\Af{g̱}-\Sf{du}-	&⁎				&⁎			&⁎			&⁎		&\Qf{ka}\Af{x̱}\Sf{du}\df{\Ff{s}}	&⁎		&⁎		&\Qf{ka}\Af{x̱}\Sf{du}\\
\Qf{x̱ʼe}- ‘mouth’	&\Af{g̱}-	&\Sf{du}-	&\Qf{x̱ʼe}-\Af{g̱}-\Sf{du}-	&⁎				&⁎			&⁎			&⁎		&\Qf{x̱ʼa}\Af{x̱}\Sf{du}\df{\Ff{s}}	&⁎		&⁎		&\Qf{x̱ʼa}\Af{x̱}\Sf{du}\\
\Qf{ji}- ‘hand’		&\Af{g̱}-	&\Sf{du}-	&\Qf{ji}-\Af{g̱}-\Sf{du}-	&⁎				&⁎			&⁎			&⁎		&\Qf{ji}\Af{x̱}\Sf{du}\df{\Ff{s}}	&⁎		&⁎		&\Qf{ji}\Af{x̱}\Sf{du}\\
\Qf{tu}- ‘inside’	&\Af{g̱}-	&\Sf{du}-	&\Qf{tu}-\Af{g̱}-\Sf{du}-	&⁎				&⁎			&⁎			&⁎		&\Qf{tu}\Af{x̱}\Sf{du}\df{\Ff{s}}	&⁎		&⁎		&\Qf{tu}\Af{x̱}\Sf{du}\\
\bottomrule
\end{tabular}
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}	& Subj.\rlap{ →}& Prefixes			&\Df{t}-\Ff{s}-\If{i}\rlap{-}	&\Df{t}-\If{i}\rlap{-}	&\Ff{s}-\If{i}\rlap{-}	&\Df{t}-	&\Df{t}-\Ff{s}\rlap{-}				&\Ff{s}-	&\If{i}-	&—\\
\midrule                                                                                                                                                                                                                                                                
—			&\Af{q}-	&\Sf{tu}-	&\Af{q}-\Sf{tu}-		&⁎				&⁎			&⁎			&⁎		&\Af{q}\Ef{a}.\Sf{tu}\df{\Ff{s}}		&⁎		&⁎		&\Af{q}\Ef{a}.\Sf{tu}\\
\Qf{ʔa}- expletive	&\Af{q}-	&\Sf{tu}-	&\Qf{ʔa}-\Af{q}-\Sf{tu}-	&⁎				&⁎			&⁎			&⁎		&\Qf{ʔa}\Af{χ}.\Sf{tu}\df{\Ff{s}}		&⁎		&⁎		&\Qf{ʔa}\Af{χ}.\Sf{tu}\\
\Qf{kʰa}- qualifier	&\Af{q}-	&\Sf{tu}-	&\Qf{kʰa}-\Af{q}-\Sf{tu}-	&⁎				&⁎			&⁎			&⁎		&\Qf{kʰa}\Af{χ}.\Sf{tu}\df{\Ff{s}}		&⁎		&⁎		&\Qf{kʰa}\Af{χ}.\Sf{tu}\\
\Qf{χʼe}- ‘mouth’	&\Af{q}-	&\Sf{tu}-	&\Qf{χʼe}-\Af{q}-\Sf{tu}-	&⁎				&⁎			&⁎			&⁎		&\Qf{χʼa}\Af{χ}.\Sf{tu}\df{\Ff{s}}		&⁎		&⁎		&\Qf{χʼa}\Af{χ}.\Sf{tu}\\
\Qf{tʃi}- ‘hand’	&\Af{q}-	&\Sf{tu}-	&\Qf{tʃi}-\Af{q}-\Sf{tu}-	&⁎				&⁎			&⁎			&⁎		&\Qf{tʃi}\Af{χ}.\Sf{tu}\df{\Ff{s}}		&⁎		&⁎		&\Qf{tʃi}\Af{χ}.\Sf{tu}\\
\Qf{tʰu}- ‘inside’	&\Af{q}-	&\Sf{tu}-	&\Qf{tʰu}-\Af{q}-\Sf{tu}-	&⁎				&⁎			&⁎			&⁎		&\Qf{tʰu}\Af{χ}\Qf{ʷ}.\Sf{tu}\df{\Ff{s}}	&⁎		&⁎		&\Qf{tʰu}\Af{χ}\Qf{ʷ}.\Sf{tu}\\
\bottomrule
\end{tabular}
