...
\FIXME{Organization – perfective, prospective, unmarked (∅), \fm{n-} prefix, \fm{g̱-} prefix, \fm{g-} prefix.
For each of \fm{∅}, \fm{n-}, \fm{g̱-}, \fm{g-}, further subsections for irrealis, modal \fm{g̱-}, and irrealis + modal.}

\FIXME{Key — \Qf{object or qualifier/incorporate}, \Rf{irrealis}, \Af{aspect}, \Mf{modality}, \Sf{subject}, \Df{classifier \fm{d-} prefix}, \Ff{classifier \fm{s-}/\fm{l-}/\fm{sh-} prefix}, \If{classifier \fm{i-} prefix}, \Ef{epenthesis}, \Xf{deletion}}

\FIXME{Since all vowels are low tone, for simplicity in the IPA transcriptions tone is not indicated.}
...
\FIXME{Absence of a prefix or output form is given as ‘—’.}

\FIXME{Lines with no prefixes in the first columns are continuations of a preceding line.}
