...
Potential modality forms normally include the stative \fm{\Rf{i}-} classifier prefix.
The only context where they are known to lack \fm{\Rf{i}-} is when they are marked for past tense (“decessive”) with the past suffix \fm{-ín}.
We would expect subordinate clause forms of potential modality to also lack \fm{\Rf{i}-} but there are no attested examples and no records of testing this possibility.
Crucially, negation of a potential modality form does not suppress \fm{\Rf{i}-} unlike negation of other forms with \fm{\Rf{i}-}.
\end{multicols}
